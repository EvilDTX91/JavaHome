...
public class DangerV2 extends JPanel implements Runnable, ChangeListener{
    //the frame that loaded this panel
    DangerFrameV2 sp;
    ...
    public DangerV2(String warning, DangerFrameV2 sp){
    ...
    // store the frame that contains this panel
    this.sp = sp;
    //a hátérszín elkészítése beállítása
   /* Color current = new Color(Integer.parseInt(sp.red.getText()), 
             Integer.parseInt(sp.green.getText()),
            Integer.parseInt(sp.blue.getText()));*/
    background = new Color(Integer.parseInt(sp.red.getText()),Integer.parseInt(sp.green.getText()),Integer.parseInt(sp.blue.getText()));
    ...
    public void run(){
        ...
        while(runner == thisThread){
            ...
            int speed = 100 - sp.speed.getValue();
            pause(speed);
            brightness += 0.05;
    ...
    public void stateChanged(ChangeEvent evt){
            Color current = new Color(Integer.parseInt(sp.red.getText()),Integer.parseInt(sp.green.getText()),Integer.parseInt(sp.blue.getText()));
            changeColor(current);
            sp.repaint();
        }
